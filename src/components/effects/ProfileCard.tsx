...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  useEffect(() => {
    ...
    const handleClick = () => {
      ...
      // @ts-ignore - DeviceMotionEvent might not have requestPermission on all browsers
        ...
        <section className="pc-card">
          <div className="pc-inside">
            ...
            <div className="pc-content">
              ...
              {children && (
                <div 
                  className="pc-custom-content w-full absolute bottom-0 left-0 p-6 z-10" 
                  style={{ pointerEvents: 'auto', background: 'linear-gradient(to top, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0.4) 70%, transparent 100%)' }}
                >
                  {children}
                </div>
              )}
